    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="source/img/slide/giao-hoa-toan-quoc-ngay-quoc-te-phu-nu-banner.jpg" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
                <img src="source/img/slide/gio-hoa-tuoi-banner.jpg" class="d-block w-100" alt="...">
            </div>
        </div>
